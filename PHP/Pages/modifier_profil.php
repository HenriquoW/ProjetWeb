    ...
    $UtilisateurEnCours = $_SESSION['UtilisateurCourant'];
		...
		<p>
			    ...
			    if( $YearToday - $YearUser < '18')
          {
            ...
            echo '
			        <label> Nom </label>
              <input name="nom_responsable" value="$Parent->getNom()" type="text" disabled/> </br>
			        <label> Prenom </label>
              <input name="prenom_responsable" value="$Parent->getPrenom()" type="text" disabled/> </br>
			        <label> Coordonnees </label>
              <textarea name="coordonnees_responsable" value="$Parent->getTelephone $Parent->getAdresse()" type="text" disabled> </textarea>
		    	      ';
              }
		    ?>
		</p>
				...
				if ($ClasseUtilisateur == 'Competiteur')
        {
          ...
          if($nbID>=1)
          {
            ...
            echo '
				      ...
				      <input name="dernier_resultat" input="text" value="$DernierPalmares->getClassement()" disabled/> </br>
              ';
            $nbID=$nbID-1;  
          }
          if($nbID>=1)
          {
            ...
            echo '
				      ...
				      <input name="avant_dernier_resultat" input="text" value="$AvantDernierPalmares->getClassement()" disabled /> </br>
              ';
            $nbID=$nbID-1;  
          }
          if($nbID>=1)
